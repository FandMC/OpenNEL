...
[RegisterPacket(EnumConnectionState.Play, EnumPacketDirection.ServerBound, 0x09, EnumProtocolVersion.V1122, false)]
public class CPacketPluginMessage : IPacket
{
	...
	{
		return ((EventArgsBase)EventManager.Instance.TriggerEvent<EventPluginMessage>("base_1122", new EventPluginMessage(connection, (EnumPacketDirection)0, Identifier, Payload))).IsCancelled;
	}
}
