...
namespace OpenNEL.GameLauncher.Services.Java.RPC.Events;
            ...
            switch (Type.GetTypeCode(type))
            {
                case TypeCode.Object:
                    ...
                    else if (type == typeof(List<uint>))
                    {
                        ...
                        list.AddRange(bytes);
                        foreach (uint item in (List<uint>)obj)
                        {
                    ...
                    else if (type == typeof(List<ulong>))
                    {
                        ...
                        foreach (ulong item2 in (List<ulong>)obj)
                        {
                    ...
                    else if (type == typeof(List<long>))
                    {
                        ...
                        foreach (long item3 in (List<long>)obj)
                        {
