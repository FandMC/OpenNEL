...
namespace Codexus.Base108X.Plugin.Packet.Play.Server;

[RegisterPacket(EnumConnectionState.Play, EnumPacketDirection.ClientBound, 0x3F, EnumProtocolVersion.V108X, false)]
public class SPacketPluginMessage : IPacket
{
	...
	{
		return ((EventArgsBase)EventManager.Instance.TriggerEvent<EventPluginMessage>("base_108x", new EventPluginMessage(connection, (EnumPacketDirection)1, Identifier, Payload))).IsCancelled;
	}
}
